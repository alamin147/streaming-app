...
const blogPosts = [
  {
    ...
    image: "/images/blog/streaming-tips.jpg",
    date: "June 10, 2025",
  ...
  },
  {
    ...
    image: "/images/blog/future-streaming.jpg",
    date: "May 22, 2025",
  ...
  },
  {
    ...
    image: "/images/blog/build-audience.jpg",
    date: "April 30, 2025",
        ...
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4 md:p-6">
          <div className="bg-card rounded-lg w-full max-w-[95%] md:max-w-3xl lg:max-w-4xl max-h-[80vh] md:max-h-[85vh] overflow-y-auto">
            <div className="p-4 md:p-8">
              ...
              <div className="h-48 md:h-64 bg-muted/50 relative mb-6 rounded-md">
                <div className="absolute inset-0 flex items-center justify-center text-muted-foreground">
                  <span className="text-sm md:text-base">Featured Image</span>
                </div>
              </div>
