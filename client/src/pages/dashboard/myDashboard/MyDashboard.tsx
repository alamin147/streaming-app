...
import { TrendingUp, Users, Eye, Film, Calendar, Clock } from "lucide-react";
...
} from "@/redux/features/dashboard/userDashboard/dashboardStatsApi";
          ...
          <div className="grid gap-6 md:grid-cols-7">
            ...
            <Card className="col-span-7 border border-gray-800/20 dark:border-gray-100/10">
              <CardHeader>
                ...
                <CardDescription>Upcoming releases and events</CardDescription>
              </CardHeader>
              <CardContent>
